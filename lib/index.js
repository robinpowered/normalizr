...
function visitObject(obj, schema, bag, options) {
  ...
  var assignEntityCompleted = options.assignEntityCompleted;
  ...
  var schemaAssignEntityCompleted = schema && schema.getAssignEntityCompleted && schema.getAssignEntityCompleted();
